function [f, grad, gbias] = nMarginalLinearOneGP(x, y, meanConst, dimBias)
%NMARGINALLINEARONEGP [f, grad, gradbias] = nMarginalLinearOneGP(x, y, meanConst, dimBias)
%   
...
if nargout >= 2
  ...
  grad(offset + 1) = 0.5 * traceAB(invKyMinusAlpha2,dKdi);
